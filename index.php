<?php
// INSERT INTO `notes` (`sno`, `title`, `description`, `tstamp`) VALUES (NULL, 'Task to do', 'Hello Tahir you have to complete this project today and after completion please delete this note so that you don\'t have any pending task.', '2021-09-15 12:14:54.000000');
...
echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
  <strong>SUCCES!</strong> Your note  has been submitted
...
if($update){
echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
  <strong>SUCCES!</strong> Your note  has been updated
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
...
if($delete){
echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
  <strong>SUCCES!</strong> Your note  has been deleted
  <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
</div>';
}
  ?>
